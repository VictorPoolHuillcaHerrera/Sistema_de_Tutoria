  ...
  return (
    ...
    >
      ...
      <Menu iconShape="circle">
          ...
          <MenuItem icon={<FaFileInvoice />}> {intl.formatMessage({ id: 'Alumnos tutorados' })}</MenuItem>

          <MenuItem icon={<FaFileInvoice />}> {intl.formatMessage({ id: 'Registrar fichas de tutoria' })}</MenuItem>

          <MenuItem icon={<FaFileInvoice />}> {intl.formatMessage({ id: 'Registrar informe quincenal' })}</MenuItem>

          <MenuItem icon={<FaFileInvoice />}> {intl.formatMessage({ id: 'Registrar informe semestral' })}</MenuItem>
